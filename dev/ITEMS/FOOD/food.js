...
Item.createFoodItem("spidereyesoup", "Spider Eye Soup", {name: "spidereyesoupitem", meta: 0}, {food: 8});
...
Item.createFoodItem("zombiejerky", "Zombie Jerky", {name: "zombiejerkyitem", meta: 0}, {food: 4});
...
Item.createItem("currypowder", "Curry Powder", {name: "currypowderitem", meta: 0});
...
Item.createFoodItem("vindaloo", "Vindaloo", {name: "vindalooitem", meta: 0}, {food: 10});
...
Item.createFoodItem("sausage", "Sausage", {name: "sausageitem", meta: 0}, {food: 6});
